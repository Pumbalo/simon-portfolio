      ...
      <ul className={styles.navbar_nav}>
        <li className={styles.logo}>
          <a href="#" className={styles.nav_link}>
            <span className={styles.link_text}>Simon</span>
        ...
        <li className={styles.nav_item}>
          <Link to="/Experience" className={styles.nav_link}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
        ...
        <li className={styles.nav_item}>
          <a
            href="https://www.linkedin.com/in/simon-sj%C3%B6%C3%B6-9a4712220/"
            target="_blank"
            className={styles.nav_link}
          >
            <svg
        ...
        <li className={styles.nav_item}>
          <a
            href="https://www.instagram.com/simmesjoo11/"
            target="_blank"
            className={styles.nav_link}
          >
            <svg
